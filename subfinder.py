...
def find_subdomains(domain, output_file):
    print(f"{Fore.CYAN}[>] {Fore.WHITE}Mencari Subdomain {Fore.YELLOW}{domain}")
    ...
    if result.stdout:
        ...
        print(f"{Fore.GREEN}[+] {Fore.WHITE}Hasil untuk {Fore.YELLOW}{domain} {Fore.GREEN}telah disimpan.")
